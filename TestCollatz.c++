...
TEST(Collatz, read_3) {
    std::istringstream r("24 91\n");
    const std::pair<int, int> p = collatz_read(r);
    ASSERT_EQ( 24, p.first);
    ASSERT_EQ( 91, p.second);
}
...
TEST(Collatz, solve_3) {
    std::istringstream r("50 150\n150 200\n200 250\n250 300\n");
    std::ostringstream w;
    collatz_solve(r, w);
    ASSERT_EQ("50 150 122\n150 200 125\n200 250 128\n250 300 123\n", w.str());
}
